...
export default {
  ...
  SIGNIN_HEADING: 'Continue With Text2Next',
  SIGNIN_SUBHEADING: 'To use Text2Next you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using Text2Next, you agree to the collection of usage data for analytics.',
